window.buttonSetup = {
    ...
    icon:"fa-fire",
    permission:"shooting",
    event:"bs-product-shooting-friend-force",
    class:"btn btn-default",
    rel:"tooltip",
    title:"Forza inserimento prodotti in uno shooting chiuso",
    placement:"bottom",
    toggle:"modal"
};

$(document).on('bs-product-shooting-friend-force', function (e, element, button) {
    let products = [];
    let getVarsArray = [];
    ...
    let bsModal = new $.bsModal('Forza inserimento', {
        body: '<div class="form-group form-group-default required">' +
        '<p>Questa procedura forza l\'inserimento di uno o più prodotti all\'interno di una prenotazione chiusa. Questo evento verrà notificato via mail presso Iwes SNC</p>' +
    ...
    $.ajax({
        method: 'GET',
        url: '/blueseal/xhr/ProductShootingFriendForceAddAjaxController'
    }).done(function (res) {
