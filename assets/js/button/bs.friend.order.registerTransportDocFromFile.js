...
$(document).on('bs.friend.order.registerTransportDocFromFile', function () {
    ...
    $.ajax({
        url: '/blueseal/xhr/FriendTransportDocumentWithFile',
        method: 'GET',
        dataType: 'json',
        data: {rows}
    }).fail(function(res){
        ...
        if (!res.error) {
            ...
            var invoiceForm = '<form id="sendInvoiceWithFile">' +
                ...
                '<div class="row">' +
                    ...
                    '<div class="col-sm-6">' +
                        '<div class="form-group">' +
                        '<label for="invoiceNumber">Numero DDT</label>' +
