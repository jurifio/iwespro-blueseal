...
var couponType=0;
    ...
    if (typeof params.id != 'undefined') {
        $.ajax({
            ...
            var bodyresicoupon;
            bodyresicoupon = bodyresicoupon + '<table id="myTable"><tr><th style="width:5%;">id</th><th style="width:10%;">Coupon</th><th style="width:15%;">Descrizione</th><th style="width:15%;">Validità</th><th style="width:15%;">tipo Coupon</th><th style="width:10%;">Stato</th><th style="width:15%;">Campagna</th><th style="width:15%;">Attiva</th><th style="width:15%;">Operazioni</th></tr>';
