(function($) {
    ...
    Pages.prototype.isVisibleXs = function() {
        var xs = $('#pg-visible-xs');
        (!xs.length) && this.$body.append('<div id="pg-visible-xs" class="visible-xs" />');
        return xs.is(':visible');
    };

    Pages.prototype.isVisibleSm = function() {
        var sm = $('#pg-visible-sm');
        (!sm.length) && this.$body.append('<div id="pg-visible-sm" class="visible-sm" />');
        return sm.is(':visible');
    };

    Pages.prototype.isVisibleMd = function() {
        var md = $('#pg-visible-md');
        (!md.length) && this.$body.append('<div id="pg-visible-md" class="visible-md" />');
        return md.is(':visible');
    };

    Pages.prototype.isVisibleLg = function() {
        var lg = $('#pg-visible-lg');
        (!lg.length) && this.$body.append('<div id="pg-visible-lg" class="visible-lg" />');
        return lg.is(':visible');
    };
    ...
    Pages.prototype.getColor = function(color, opacity) {
        ...
        var newcolor = colorElem.css('background-color');

        var rgb = newcolor.match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/);
    ...
    Pages.prototype.initTooltipPlugin = function() {
        $.fn.tooltip && $('[data-toggle="tooltip"],[rel="tooltip"]').tooltip({container: 'body', delay: { "show": 500, "hide": 100 }});
    };
        ...
        $.validator && $.validator.setDefaults({
            ...
            showErrors: function(errorMap, errorList) {
                ...
                return $.each(errorList, function(index, value) {
                    ...
                    var newparent = $(value.element).closest('.form-group');
                    newparent.addClass('has-error');
...
(function($) {
    ...
    var Sidebar = function(element, options) {
        ...
        this.$element.bind('mouseenter', function() {
            timer = setTimeout(sidebarMouseEnter, 400);
        });
...
(function($) {
    ...
    var Search = function(element, options) {
        this.$element = $(element);
        this.options = $.extend(true, {}, $.fn.searchPages.defaults, options);
        this.init();
    };
    ...
    Search.prototype.keypress = function(e) {
        ...
        if ($('body').hasClass('overlay-disabled') ||
            $(e.target).hasClass('js-input') || $(e.target).prop('contenteditable') == 'true' ||
            nodeName == 'INPUT' ||
            nodeName == 'TEXTAREA') {
            return;
        }
    ...
    var old = $.fn.searchPages;

    $.fn.searchPages = Plugin;
    $.fn.searchPages.Constructor = Search;

    $.fn.searchPages.defaults = {
    ...
    $.fn.searchPages.noConflict = function() {
        $.fn.search = old;
        return this;
    };
