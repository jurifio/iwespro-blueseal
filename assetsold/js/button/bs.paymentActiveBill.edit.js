window.buttonSetup = {
    ...
    event: "bs-paymentBillActiveBill-edit",
...
$(document).on('bs-paymentBillActiveBill-edit', function (e, element, button) {
    ...
    Pace.ignore(function () {
        $.ajax({
            method: "get",
            url: "/blueseal/xhr/BillRegistryActivePaymentBillManage",
            data: {
