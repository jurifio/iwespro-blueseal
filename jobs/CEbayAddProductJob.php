                    ...
                    foreach ($reservedIds as $reservedId) {
                     ...
                     and id_shop=' . $marketplace['prestashopId'] . ' and id_marketplace=' . $market['marketplaceId'] . ' limit 1');
                            ...
                            if ($productEanParent) {
                                ...
                                $productEanSelect->productId=$reservedId['productId'];
                                $productEanSelect->productVariantId=$reservedId['productVariantId'];
                                $productEanSelect->productSizeId=0;
                                $productEanSelect->usedForParent=1;
                                $productEanSelect->used=1;
                                $productEanSelect->brandAssociate=$product->productBrandId;
                                $productEanSelect->shopId=$marketplace['shopId'];
