...
/**
 * Class CPrestashopAddProductEbayJob
 ...
 * @since 1.0
 */
class CPrestashopAddProductEbayJob extends ACronJob
{
    /**
     * @param null $args
    ...
    public function run($args = null)
    {
        ...
        $url = 'https://iwes.shop/modules/fastbay1/ajax/fastbay1SyncCron.php?s=1&mp=101&token=be8124d84d1ba9e36cc84434373b38f8&add=1';
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_HTTPHEADER, array("Content-type: multipart/form-data"));
        curl_setopt($ch, CURLOPT_URL, $url);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        ...
        $res="Aggiungi Nuovi  Prodotti Ebay   finito alle ore ".date('Y-m-d H:i:s');
