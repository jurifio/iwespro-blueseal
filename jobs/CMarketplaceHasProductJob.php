...
class CMarketplaceHasProductJob extends ACronJob
{
 ...
 and p.productVariantId=shp.productVariantId where p.qty>0  and p.productSeasonId > 36 and  shp.shopId =' . $marketplaceAccount->config['shopId'] . '  ' . $sqlBrandFilter . ' ) UNION
(select p2.id as productId, p2.productVariantId as productVariantId, p2.qty as qty, shp2.shopIdDestination as shopId from
 ...
 and p2.productVariantId=shp2.productVariantId where p2.qty> 0  and p2.productSeasonId > 36 and  shp2.shopIdDestination =' . $marketplaceAccount->config['shopId'] . '  ' . $sqlBrandParallelFilter . ')';
