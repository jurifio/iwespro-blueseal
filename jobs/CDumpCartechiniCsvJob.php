...
(SELECT CONCAT(GROUP_CONCAT(`parent40`.`slug` SEPARATOR ' | '),' | ',`node40`.`slug`) FROM `ProductCategory` AS `node40`,
 ...
 (SELECT if(`pp2`.`local`=null,concat('https://cdn.iwes.it/',pb.slug,'/',`pp2`.`name`),concat('https://iwes.pro/product/',`pp2`.`name`))  FROM ProductPhoto pp2  JOIN ProductHasProductPhoto phpp2 ON phpp2.productPhotoId=pp2.id
			...
			(SELECT if (`pp21`.`local`=null, GROUP_CONCAT(concat('https://cdn.iwes.it/',pb.slug,'/',`pp21`.`name`) SEPARATOR '|'),GROUP_CONCAT(concat('https://iwes.pro/product/',`pp21`.`name`) SEPARATOR '|')) FROM ProductPhoto pp21  JOIN ProductHasProductPhoto phpp21 ON phpp21.productPhotoId=pp21.id
			WHERE phpp21.productId=p.id AND phpp21.productVariantId=p.productVariantId AND pp21.size='1124') as Images,
			
	(SELECT if(`pp22`.`local`=null,concat('https://cdn.iwes.it/',pb.slug,'/',`pp22`.`name`),concat('https://iwes.pro/product/',`pp22`.`name`)) FROM ProductPhoto pp22  JOIN ProductHasProductPhoto phpp22 ON phpp22.productPhotoId=pp22.id
			...
			(SELECT if(`pp23`.`local`=null,concat('https://cdn.iwes.it/',pb.slug,'/',`pp23`.`name`),concat('https://iwes.pro/product/',`pp23`.`name`))  FROM ProductPhoto pp23  JOIN ProductHasProductPhoto phpp23 ON phpp23.productPhotoId=pp23.id
 ...
 (SELECT if(`pp24`.`local`=null,concat('https://cdn.iwes.it/',pb.slug,'/',`pp24`.`name`),concat('https://iwes.pro/product/',`pp24`.`name`))  FROM ProductPhoto `pp24`  JOIN ProductHasProductPhoto phpp24 ON phpp24.productPhotoId=pp24.id
 ...
 (SELECT if(`pp25`.`local`=null,concat('https://cdn.iwes.it/',pb.slug,'/',`pp25`.`name`),concat('https://iwes.pro/product/',`pp25`.`name`))  FROM ProductPhoto pp25  JOIN ProductHasProductPhoto phpp25 ON phpp25.productPhotoId=pp25.id
...
'' AS `Image 7`,
'' AS `Image 8`,	
 (SELECT if(`pp26`.`local`=null,concat('https://cdn.iwes.it/',pb.slug,'/',`pp26`.`name`),concat('https://iwes.pro/product/',`pp26`.`name`)) FROM ProductPhoto pp26  JOIN ProductHasProductPhoto phpp26 ON phpp26.productPhotoId=pp26.id
