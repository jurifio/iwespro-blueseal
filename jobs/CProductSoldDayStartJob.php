 ...
 * @since 1.0
 */
class CProductSoldDayStartJob extends ACronJob
{
    ...
    public function run($args = null)
    {
        ...
        $this->report('ProductSoldDayStartJob','start day quantity check','');
    }
...
';
            ...
            foreach ($res as $result) {
                $productSoldDay = $productSoldDayRepo->getEmptyEntity();
                ...
                $productSoldDay->insert();
            }
            $this->report('ProductSoldDayStartJob','end day Quantity check','');
        } catch(\Throwable $e){
            $this->report('ProductSoldDayStartJob','Error',$e->getMessage());
        }
