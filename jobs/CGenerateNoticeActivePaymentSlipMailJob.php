...
/**
 * Class CGenerateNoticeActivePaymentSlipMailJob
 ...
 * @since 1.0
 */
class CGenerateNoticeActivePaymentSlipMailJob extends ACronJob
{
    /**
     * @param null $args
     */
    ...
    {
        $this->generateNoticeActivePaymentSlipMail();
    }

    /**
     * @param int $days
     */
    public function generateNoticeActivePaymentSlipMail()
    {
