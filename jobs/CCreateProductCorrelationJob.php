        ...
        try {
            ...
            foreach ($products as $product) {
                ...
                if ($findProductCorrelation == null) {
                    ...
                    $findProductCorrelationInsert->image = $app->image($product->getPhoto(1,CProductPhoto::SIZE_THUMB),'amazon');
                    ...
                    foreach ($shopHasProduct as $pr) {
                        ...
                        if ($findProductHasProductCorrelation == null) {
                            ...
                            $findProductHasProductCorrelationInsert->productVariantId = $productVariantId;
