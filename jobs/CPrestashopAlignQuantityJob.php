            ...
            foreach ($res_product as $value_product) {
             ...
             WHERE id_product=" . $p);
                ...
                if ($value_product['titleSale'] == 1) {
                    ...
                    $titleTextSaleLang1 = str_replace("'", "\'", $productbrandName) . " " . $productnameName . " " . $productitemnoName . " " . $productcolorSupplierName . " Sconto del  " . number_format($value_product['percentSale'],0,',','.') . " % da Euro " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a Euro " . number_format($value_product['salePrice'], 2, ',', '.');
                    $titleTextSaleLang3 = str_replace("'", "\'", $productbrandName) . " " . $productnameName . " " . $productitemnoName . " " . $productcolorSupplierName . " Sconto del  " . number_format($value_product['percentSale'],0,',','.') . " % da  Euro " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a Euro " . number_format($value_product['salePrice'], 2, ',', '.');
...
//
                    ...
                    $stmtUpdateProductLang = $db_con->prepare("UPDATE psz6_product_lang SET `description`='" . $descriptionTextSaleLang2 . "',`name`='" . $titleTextSaleLang2 . "', meta_title='" . $titleTextSaleLang2 . "' WHERE id_product=" . $p . " AND id_lang=1 AND id_shop=" . $value_product['shopPrestashopId'] . "  ");
                    $stmtUpdateProductLang->execute();
                    $stmtUpdateProductLang = $db_con->prepare("UPDATE psz6_product_lang SET `description`='" . $descriptionTextSaleLang1 . "',`name`='" . $titleTextSaleLang1 . "', meta_title='" . $titleTextSaleLang1 . "' WHERE id_product=" . $p . " AND id_lang=2 AND id_shop=" . $value_product['shopPrestashopId'] . "  ");
                    $stmtUpdateProductLang->execute();
