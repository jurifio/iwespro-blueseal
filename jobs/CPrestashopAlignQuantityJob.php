            ...
            foreach ($res_product as $value_product) {
             ...
             WHERE id_product=" . $p);
                ...
                if ($value_product['titleSale'] == 1) {
                    ...
                    $titleTextSaleLang1 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName)  . " Sconto del  " . number_format($value_product['percentSale'],0,',','.') . " % da € " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a € " . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );
                    $titleTextSaleLang3 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName)  . " Sconto del  " . number_format($value_product['percentSale'],0,',','.') . " % da  € " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a € " . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );
                    ...
                    $descriptionTextSaleLang1 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " " . $productnameName . " " . $productitemnoName . " " . $productcolorSupplierName . " Scontato del  " . number_format($value_product['percentSale'],0,',','.') . " % da € " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a € " . number_format($value_product['salePrice'], 2, ',', '.'));
                    $descriptionTextSaleLang3 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " " . $productnameName . " " . $productitemnoName . " " . $productcolorSupplierName . " Scontato del  " . number_format($value_product['percentSale'],0,',','.') . " % da € " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a € " . number_format($value_product['salePrice'], 2, ',', '.'));
                    ...
                    $descriptionshortTextSaleLang1 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " Sconto del  " . number_format($value_product['percentSale'],0,',','.') . " % da € " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a € " . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );
                    $descriptionshortTextSaleLang3 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " Sconto del  " . number_format($value_product['percentSale'],0,',','.') . " % da € " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a € " . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );
