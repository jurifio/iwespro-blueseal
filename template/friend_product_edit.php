                                            ...
                                            <div class="form-group form-group-default selectize-enabled">
                                                ...
                                                <select class="full-width selectpicker"
                                                    ...
                                                    <?php foreach ($productSheets as $productSheet): ?>
                                                        <option value="<?php echo $productSheet->id ?>" <?php if (isset($productEdit))  {
                                                            if ($productSheet->id == $productEdit->productSheetPrototypeId) echo "selected";
                                                        } ?>> <?php echo $productSheet->name ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div style="display:none" id="productDetailsStorage"><?php echo (isset($productDetails)) ? json_encode($productDetails) : ''; ?></div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group form-group-default" style="height: 50px">
                                                ...
                                                <input type="hidden" id="hidden-name" class="hidden-name" value="<?php echo ((isset($productEdit)) && !is_null($productEdit->productNameTranslation->getFirst())) ? $productEdit->productNameTranslation->getFirst()->name : "" ?>" />
