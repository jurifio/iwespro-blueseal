            ...
            <div class="container-fluid container-fixed-lg bg-white">
                <div class="panel panel-transparent">
                    ...
                    <div class="panel-body">
                        <table class="table table-striped responsive" width="100%" data-datatable-name="description_lang_list" data-controller="DescriptionTranslateLangAllListAjaxController" data-lang="<?php echo $langId; ?>" data-url="<?php echo $app->urlForBluesealXhr() ?>">
                            <thead>
                                <tr>
