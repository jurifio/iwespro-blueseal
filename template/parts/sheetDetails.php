...
<div class="row">
    <div class="col-md-12 detailContent" data-category="<?php echo $categories; ?>" data-prototype-id="<?php if (isset($productSheetPrototype)) echo $productSheetPrototype->id; ?>" data-product-name="<?php echo $productName ?>">
