<div class="row">
    <div class="col-md-12 detailContent" data-prototype-id="<?php echo $productSheetPrototype->id; ?>" data-product-name="<?php echo ($productSheetPrototype->productName) ? $productSheetPrototype->productName : ''; ?>">
