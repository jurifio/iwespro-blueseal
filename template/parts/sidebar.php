<nav class="page-sidebar" data-pages="sidebar">
    ...
    <div class="sidebar-header">
        <div class="sidebar-logo">
            <img src="/assets/img/blueseal_logo_symbol.png" alt="logo" class="brand" data-src="/assets/img/blueseal_logo_symbol.png" data-src-retina="/assets/img/blueseal_logo_symbol.png" width="42">
            <img class ="brand" width="120" src="/assets/img/logo_no_symbol_white.png" data-src-retina="/assets/img/logo_no_symbol_white.png" data-src="/assets/img/logo_no_symbol_white.png" />
        </div>
    </div>
