    ...
    <div class="pull-left sm-table">
        <div class="header-inner">
            <div class="brand inline">
                <img src="/blueseal/assets/img/logo_no_symbol.png" alt="logo" data-src="/blueseal/assets/img/logo_no_symbol.png" data-src-retina="/blueseal/assets/img/logo_no_symbol.png" width="120">
            </div>
    ...
    <div class="pull-right">
        <div class="visible-lg visible-md m-t-10 user-account">
            ...
            <div class="thumbnail-wrapper d32 circular inline m-t-5">
                <img src="/blueseal/assets/img/profiles/default.jpg" alt="" data-src="/blueseal/assets/img/profiles/default.jpg" data-src-retina="/blueseal/assets/img/profiles/default.jpg" width="55" height="55">
            </div>
