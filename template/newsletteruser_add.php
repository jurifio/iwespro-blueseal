                            ...
                            <div class="panel panel-default clearfix">
                                ...
                                <div class="panel-body clearfix">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group form-group-default selectize-enabled">
                                                <label for="data">Descrizione Newletter</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group form-group-default selectize-enabled">
                                                ...
                                                <input type="text" class="form-control" id="fromEmailAddressId" name="fromEmailAddressId" value="no-reply@.pickyshop.com" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
