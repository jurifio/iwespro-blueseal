...
<div class="container-fluid container-fixed-lg">
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            <div class="invoice padding-50 sm-padding-10">
                <div>
                    <div class="pull-left">
                        ...
                        <div>
                            <div class="pull-left font-montserrat all-caps small"><strong>Fattura N. :</strong>
                                <?php echo '  '. $invoice->invoiceNumber . '<strong> del </strong>' . $invoiceDate->format('d-m-Y');?></div>
                    ...
                    <table class="table invoice-table m-t-0">
                        ...
                        <br><tr class="text-left font-montserrat small"><td style="border: 0px"></td>
                            <td style="border: 0px"></td><td style="border: 0px"><strong>Totale della merce</strong></td>
                            <td style="border: 0px" class="text-center"><?php echo money_format('%.2n', $tot) . ' &euro;'; ?></td></tr>
                        ...
                        <tr class="text-left font-montserrat small"><td style="border: 0px"></td>
                            <td style="border: 0px"></td><td class="separate"><strong>Spese di spedizione</strong></td><td class="separate text-center"><?php echo money_format('%.2n', $order->shippingPrice) . ' &euro;'; ?></td></tr>
                        <tr style="border: 0px" class="text-left font-montserrat small hint-text">
                            ...
                            <td class="semi-bold"><h4>Totale Fattura</h4></td><td class="semi-bold text-center"><h2><?php echo money_format('%.2n', $order->netTotal) . ' &euro;'; ?></h2></td></tr>
            ...
            <br>
            <div>
                <center><img alt="" class="invoice-thank" data-src-retina='http://www.pickyshop.com/blueseal/assets/img/invoicethankyou.jpg' data-src='http://www.pickyshop.com/blueseal/assets/img/invoicethankyou.jpg' src='http://www.pickyshop.com/blueseal/assets/img/invoicethankyou.jpg'>
            </center>
            </div>
            <br>
            <br>
