...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        <div class="content sm-gutter">
            ...
            <input type="hidden" id="cartIdEmailParam1" name="cartIdEmailParam1" value="<?php echo $collectCartAbandonedEmailParam[1]['id'];?>"/>
            <input type="hidden" id="cartIdEmailParam2" name="cartIdEmailParam2" value="<?php echo $collectCartAbandonedEmailParam[2]['id'];?>"/>
            <input type="hidden" id="cartIdEmailParam3" name="cartIdEmailParam3" value="<?php echo $collectCartAbandonedEmailParam[3]['id'];?>"/>
            <input type="hidden" id="couponTypeId1" name="couponTypeId1" value="<?php echo $collectCartAbandonedEmailParam[1]['couponTypeId'];?>"/>
            <input type="hidden" id="couponTypeId2" name="couponTypeId2" value="<?php echo $collectCartAbandonedEmailParam[2]['couponTypeId'];?>"/>
            <input type="hidden" id="couponTypeId3" name="couponTypeId3" value="<?php echo $collectCartAbandonedEmailParam[3]['couponTypeId'];?>"/>
            ...
            <input type="hidden" id="validForCartTotal1" name="validForCartTotal1" value="<?php echo $validForCartTotal1;?>"/>
            ...
            <input type="hidden" id="validForCartTotal2" name="validForCartTotal2" value="<?php echo $validForCartTotal2;?>"/>
            ...
            <input type="hidden" id="validForCartTotal3" name="validForCartTotal3" value="<?php echo $validForCartTotal3;?>"/>
            ...
            <input type="hidden" id="hasFreeShipping1" name="hasFreeShipping1" value="<?php echo $hasFreeShipping1;?>"/>
            ...
            <input type="hidden" id="hasFreeShipping2" name="hasFreeShipping2" value="<?php echo $hasFreeShipping2;?>"/>
            ...
            <input type="hidden" id="hasFreeShipping3" name="hasFreeShipping3" value="<?php echo $hasFreeShipping3;?>"/>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group form-group-default selectize-enabled">
                                                ...
                                                <select id="firstTemplateId" name="firstTemplateId"
                                                    ...
                                                    <option <?php if($collectCartAbandonedEmailParam[1]['firstTemplateId']==$templates->id) echo 'selected="selected"'; ?> value="<?php echo $templates->id ?>"> <?php echo $templates->name;?></option>
                                                    <?php endforeach; ?>>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group form-group-default selectize-enabled">
                                                ...
                                                <select id="secondTemplateId" name="secondTemplateId"
                                                    ...
                                                    <?php foreach($template as $templates): ?>
                                                        <option <?php if($templates->id == $collectCartAbandonedEmailParam[1]['secondTemplateId']) echo 'selected="selected"'; ?> value="<?php echo $templates->id ?>"> <?php echo $templates->name;?></option>
                                                    <?php endforeach; ?>>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group form-group-default selectize-enabled">
                                                ...
                                                <?php foreach($template as $templates): ?>
                                                    <option <?php if($templates->id == $collectCartAbandonedEmailParam[1]['thirdTemplateId']) echo 'selected="selected"'; ?> value="<?php echo $templates->id ?>"> <?php echo $templates->name;?></option>
                                                <?php endforeach; ?>>
                                                </select>
                                            </div>
                                        </div>
