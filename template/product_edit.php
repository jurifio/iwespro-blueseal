        ...
        <div class="content sm-gutter">
            ...
            <div class="container-fluid">
                <form id="form-project" enctype="multipart/form-data" role="form" action="" method="post" autocomplete="off">
                    ...
                    <input type="hidden" id="ProductCategory_id" name="ProductCategory_id" value="<?php echo implode(',',$value) ?>" />
                    <input type="hidden" id="Product_id" name="Product_id" value="<?php echo $productEdit->id?>" />
                    <input type="hidden" id="Product_productVariantId" name="Product_productVariantId" value="<?php echo $productEdit->productVariantId?>" />
                        ...
                        <div class="col-md-6">
                            <div class="panel panel-default clearfix">
                                <div class="panel-heading clearfix">
                                    <h5 class="m-t-10"><a href="<?php echo $app->productUrl($productEdit);?>"><?php echo $productEdit->id.'-'.$productEdit->productVariantId;?></a> - Informazioni di base</h5>
                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group form-group-default required">
                                                        ...
                                                        <input id="ProductVariant_name" autocomplete="off" type="text" class="form-control" name="ProductVariant_name" value="<?php echo !is_null($productEdit->productVariant) ? $productEdit->productVariant->name : "" ?>" required>
                                                        <span class="bs red corner label"><i class="fa fa-asterisk"></i></span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="tab-content bg-white">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group form-group-default">
                                                        ...
                                                        ?>
                                                        <input autocomplete="off" type="text" class="form-control" id="<?php echo "ProductDetail_1_" . $detaillabel->id ?>" name="<?php echo "ProductDetail_1_" . $detaillabel->id ?>" value="<?php echo isset($detailValue) ? $detailValue->name : "" ?>" />
                                                    </div>
                                                </div>
