                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default clearfix">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group form-group-default required">
                                            <label for="range1Cpc">Cpc 1 Dedicato</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group form-group-default required">
                                                <label for="range2Cpc">Cpc 2 Dedicato</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group form-group-default required">
                                            <label for="range3Cpc">Cpc 3 Dedicato</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group form-group-default required">
                                            <label for="range4Cpc">Cpc 4 Dedicato</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group form-group-default required">
                                            <label for="range5Cpc">Cpc 5 Dedicato</label>
