                    ...
                    <div class="panel-body">
                        <form id="form-project" role="form" action="" method="POST" autocomplete="on">
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <div class="form-group form-group-default required">
                                        <input type="hidden" id="bannerId" name="bannerId" value="<?php echo $banner->id; ?>" />
                                        <label for="name">Nome Banner</label>
                                        <input type="text" class="form-control" id="name" name="name" value="<?php echo $banner->name?>" required/>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group form-group-default required">
                                        ...
                                        <input type="text" class="form-control" id="position" name="position" value="<?php echo $banner->position?>" required/>
                                        <span class="bs red corner label"><i class="fa fa-asterisk"></i></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group form-group-default required">
                                        ...
                                        <input type="text" class="form-control" id="link" name="link" value="<?php echo $banner->link?>" required/>
                                        <span class="bs red corner label"><i class="fa fa-asterisk"></i></span>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-3">
                                    <div class="form-group form-group-default selectize-enabled">
                                        <input type='hidden' id="shopSelected" name="shopSelected"
                                               value="<?php echo $banner->remoteShopId ?>"/>
                                ...
                                <div id="divCampaignType" class="col-sm-6">
                                    <input type="hidden" id="campaignSelect" name="campaignSelect" value="<?php echo $banner->campaignId; ?>" />
                                    <div class="form-group form-group-default selectize-enabled">
