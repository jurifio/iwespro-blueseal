...
<div class="page-container">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default clearfix">
                                ...
                                <div class="panel-body clearfix">
                                    <input type="hidden" id="templateId" value="<?php echo $fixedPageTemplate->id; ?>">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group form-group-default selectize-enabled">
                                                ...
                                                <input id="name" class="form-control"
                                                       ...
                                                       required="required"
                                                       value="<?php echo $fixedPageTemplate->name; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea id="template" name="template" data-json="PostTranslation.content"
                                                      rows="50"><?php echo $fixedPageTemplate->template; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <bs-toolbar class="toolbar-definition">
        <bs-toolbar-group data-group-label="Salva il template">
            <bs-toolbar-button
                    data-tag="a"
                    data-icon="fa-save"
                    ...
                    data-rel="tooltip"
                    data-event="bs.fixed.page.template.update"
