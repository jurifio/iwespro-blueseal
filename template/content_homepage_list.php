                ...
                <div class="panel panel-transparent">
                    <div class="panel-body">
                        <table class="table table-striped responsive" width="100%"
                               data-datatable-name="homepage_list"
                               data-controller="ContentHomePageListAjaxController"
                               data-url="<?php echo $app->urlForBluesealXhr() ?>">
                            <thead>
                                <tr>
                                    <th class="center sorting">Media</th>
                                    <th class="center sorting">ID</th>
                                    <th class="center sorting">Widget</th>
                                    <th class="center sorting">Contenuto</th>
...
<bs-toolbar class="toolbar-definition">
    <bs-toolbar-group data-group-label="Widget">
        <bs-toolbar-button
            ...
            data-rel="tooltip"
            data-title="Aggiungi un nuovo widget"
        ...
        <bs-toolbar-button
            ...
            data-permission="/admin/content/edit"
            data-class="btn btn-default"
            data-event="bs.widget.translate"
            data-rel="tooltip"
            data-title="Traduci"
            data-placement="bottom"
        ></bs-toolbar-button>
