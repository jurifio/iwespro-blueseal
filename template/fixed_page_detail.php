                ...
                <div class="panel panel-transparent">
                        ...
                        <div class="row">
                            ...
                            <div class="panel-body">
                                ...
                                <input type="text" id="title" placeholder="Title"
                                       value="<?php if(!is_null($fixedPage)) echo $fixedPage->title; ?>" style="width: 30%;">
                            </div>
                            <div class="panel-body">
                                <strong style="display: block">Inserisci il sottotitolo</strong>
                                <input type="text" id="subTitle" placeholder="Sottotitolo"
                                       value="<?php if(!is_null($fixedPage)) echo $fixedPage->subtitle; ?>" style="width: 30%;">
                            </div>
                            <div class="panel-body">
                                <strong style="display: block">Inserisci lo slug</strong>
                                <input type="text" id="slug" placeholder="Slug" value="<?php if(!is_null($fixedPage)) echo $fixedPage->slug; ?>"
                                       style="width: 30%;">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <input type="text" id="titleTag" placeholder="Tag title (Caratteri: min 50 | max 60)"
                               value="<?php if(!is_null($fixedPage)) echo $fixedPage->titleTag; ?>" style="width: 30%;">
                    </div>
                    <div class="panel-body">
