                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="panel panel-default clearfix landing-header">
                            <div class="panel-heading clearfix">
                                <label for="chooseBlog">Scegli il blog</label>
                                <select id="chooseBlog">
                            ...
                            <div class="panel-body clearfix">
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="form-group form-group-default required">
                                            <label>Titolo</label>
                                            <input type="text" data-json="PostTranslation.title" autocomplete="off"
                                    ...
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="form-group form-group-default">
                                            ...
                                            <input type="text" data-json="PostTranslation.subtitle" autocomplete="off"
                                                   class="form-control"/>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="summernote-wrapper">
                                                ...
                                                <textarea class="summer" data-json="PostTranslation.content"
                                                          rows="50"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-12 col-xs-12">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input type="text" data-json="Post.author" autocomplete="off"
                                               class="form-control"/>
                                    </div>
                                </div>
                    ...
                    <div class="col-sm-3">
                        <div class="panel panel-default clearfix">
                            ...
                            <div class="panel-body clearfix">
                                <p><strong><i class="fa fa-user"></i>
                                        Autore</strong> <?php echo $user->getName() . " " . $user->getSurname() ?></span>
                                </p>
                                <p><strong><i class="fa fa-calendar"></i> Data
                                        creazione</strong> <?php echo $date->format('d-m-Y'); ?></p>
                                <input type="hidden" data-json="Post.userId" value="<?php echo $user->getId(); ?>"/>
                            </div>
                        </div>
                        <div class="panel panel-default clearfix">
                            <div class="panel-heading clearfix">
                                <h5 data-toggle="popover" data-placement="left" data-container="body"
                                    data-title="Pubblicazione posticipata"
                                    data-content="Impostare una data di pubblicazione nel futuro farà in modo che il post si auto-pubblichi in quella data/ora.">
                                    <i class="fa fa-question-circle"></i> Pubblicazione</h5>
                            </div>
                            <div class="panel-body clearfix">
                                <div class="form-group form-group-default">
                                    <label>Data pubblicazione</label>
                                    <input type="datetime-local" data-json="Post.publishDate" autocomplete="off"
                                           value="<?php echo (new DateTime())->format('Y-m-d\TH:i') ?>"
                                           class="form-control" title="Data pubblicazione"/>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default clearfix">
                            ...
                            <div class="panel-body clearfix">
                                <div class="form-group form-group-default selectize-enabled required">
                                    ...
                                    <select data-json="PostHasPostCategory.id" class="full-width" multiple="multiple"
                                            placeholder="Seleziona una o più categorie" data-init-plugin="selectize"
                                ...
                                <div class="form-group form-group-default selectize-enabled required">
                                    <label>Tag</label>
                                    <select data-json="PostHasPostTag.id" class="full-width" multiple="multiple"
                                            placeholder="Seleziona una o più tag" data-init-plugin="selectize"
                                            tabindex="-1" title="" required>
                                        <option></option>
                        ...
                        <div class="panel panel-default clearfix">
                            <div class="panel-heading clearfix">
                                <h5 data-toggle="popover" data-placement="left" data-container="body"
                                    data-title="Formato e dimensioni"
                                    data-content="Formato 16:9: larghezza minima 1140px"><i
                                            class="fa fa-question-circle"></i> Cover photo</h5>
                            </div>
                            <div class="panel-body clearfix">
                                <img src="<?php echo $defaultImage ?>" id="cover"
