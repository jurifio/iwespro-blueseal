            ...
            <div class="container-fluid container-fixed-lg bg-white">
                <div class="panel panel-transparent">
                    <div class="panel-heading">
                        <div class="panel-title">Elenco prodotti Incompleti Cartechini</div>
                        <div class="export-options-container pull-right"></div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="panel-body">
                        <table class="table table-striped" data-datatable-name="product_importer_cartechini_list"
                               data-controller="ProductImporterProblemsCartechiniListController"
                               data-url="<?php echo $app->urlForBluesealXhr() ?>"
                               data-inner-setup="true"
                               data-length-menu-setup="20, 50, 100, 200, 500"
