                ...
                <div class="panel panel-transparent">
                    ...
                    <div class="panel-body">
                        <table class="table table-striped responsive" width="100%" data-column-filter="true"
                               data-datatable-name="dictionary_edit" data-controller="DictionarySizeEditAjaxController" data-shop="<?php echo $shopId; ?>" data-url="<?php echo $app->urlForBluesealXhr() ?>">
                            <thead>
                                <tr>
