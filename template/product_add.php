                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group form-group-default required">
                                                        ...
                                                        <input id="ProductVariant_name" autocomplete="off" type="text"
                                                               class="form-control" name="ProductVariant_name" value=""
                                                               required/>
                                                        <span class="bs red corner label"><i class="fa fa-asterisk"></i></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group form-group-default required">
                                                        ...
                                                        <input id="ProductVariant_description" autocomplete="off"
                                                               ...
                                                               name="ProductVariant_description" value="" required/>
                                                        <span class="bs red corner label"><i class="fa fa-asterisk"></i></span>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group form-group-default">
                                                ...
                                                <input autocomplete="off" type="text" class="form-control"
                                                       id="Product_note" name="Product_note" value=""/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <ul class="nav nav-tabs nav-tabs-simple bg-white" id="tab-2">
                                                <?php foreach ($langs as $lang): ?>
                                                    <li class="<?php echo($lang->lang == 'it' ? "active" : "") ?>">
                                                        <a data-toggle="tab"
                                                           href="#desc<?php echo $lang->lang ?>"><?php echo $lang->name ?></a>
                                                    </li>
                                                <?php endforeach;
                                                $langs->rewind(); ?>
                                            </ul>
                                            <div class="tab-content bg-white">
                                                <?php foreach ($langs as $lang): ?>
                                                    <div class="tab-pane <?php echo($lang->lang == 'it' ? "active" : "") ?>"
                                                         id="desc<?php echo $lang->lang ?>">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group form-group-default">
                                                                    <?php if (isset($name)) unset($name); ?>
                                                                    <label for="ProductName_<?php echo $lang->id ?>_name">Nome
                                                                        del prodotto</label>
                                                                    <input autocomplete="off" type="text"
                                                                           class="form-control"
                                                                           id="ProductName_<?php echo $lang->id ?>_name"
                                                                           name="ProductName_<?php echo $lang->id ?>_name"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="summernote-wrapper">
                                                                    ...
                                                                    <textarea id="summernote<?php echo $lang->id ?>"
                                                                              class="" rows="10"
                                                                              name="ProductDescription_<?php echo $lang->id ?>"><?php echo isset($descr) ? $descr : ""; ?></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
