...
border-color: darkgrey darkgrey darkgrey darkgrey;">
                            ...
                            <div class="row panel-heading clearfix" style="padding: 48px">
                            </div>
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group form-group-default selectize-enabled">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-default selectize-enabled">
                                        ...
                                        <input id="netTotal" disabled autocomplete="off" type="text"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-default selectize-enabled">
                                        ...
                                        <input id="discountTotal" disabled autocomplete="off" type="text"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-default selectize-enabled">
                                        ...
                                        <input id="vatTotal" disabled autocomplete="off" type="text"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-default selectize-enabled">
                                        ...
                                        <input id="grossTotal" disabled autocomplete="off" type="text"
