        ...
        <div class="content sm-gutter">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="tab">
                        <div class="col-md-12">
                            <button class="tablinks" onclick="openTab(event, 'insertMarketPlaceAccount')">Modifica Marketplace
                            </button>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group form-group-default selectize-enabled">
                                                <label for="shopId">Seleziona il MarketPlace
                                                </label>
                                                <select id="shopId"
                                                        name="shopId"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input id="logoFile" type="hidden" value="<?php echo (isset($marketplaceHasShop->imgMarketPlace)) ? $marketplaceHasShop->imgMarketPlace : ''; ?>"/>
                                            <div id="returnFileLogo"><?php echo (isset($marketplaceHasShop->imgMarketPlace)) ? '<img width="50" src="' . $marketplaceHasShop->imgMarketPlace . '"/>' : ''; ?></div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group form-group-default selectize-enabled">
