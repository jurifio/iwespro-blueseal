        ...
        <div class="content sm-gutter">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="tab">
                        <div class="col-md-12">
                            <button class="tablinks" onclick="openTab(event, 'insertClient')">Ragione Sociale</button>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group form-group-default selectize-enabled">
                                        ...
                                        <select id="bankRegistryId" name="bankRegistryId"
                                                ...
                                                placeholder="Seleziona la Lista"
                                                data-init-plugin="selectize">
                                            <option value="<?php echo $bankRegistry->id ;?>"><?php echo $bankRegistry->name.' '.$bankRegistry->location.' abi:'.$bankRegistry->abi.' cab:'.$bankRegistry->cab;?></option>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row" id="rawProduct">
                                ...
                                <?php if ($brca->accountAsService == 1) {
                                    ...
                                    $bodyres .= '<table id="myTable"> <tr class="header1"><th>Categoria</th><th>Codice Prodotto</th><th>Nome Prodotto</th><th>Selezione</th></tr>';
                                    ...
                                    foreach ($brp as $product) {
                                        ...
                                        $bodyres .= '<tr><td>' . $categoryName . '</td><td>' . $codeProduct . '</td><td>' . $nameProduct . '</td><td><input type="checkbox" ' . $checked . ' class="form-control"  name="selected_values[]" value="' . $product->id . '"></td></tr>';
