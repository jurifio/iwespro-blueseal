        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="tab">
                    ...
                    <a href="/blueseal/ordini-con-righe-diverse" class="btn btn-light" role="button"><i class="fa fa-indent" aria-hidden="true"></i> Righe Diverse</a>
                </div>
                </ul>
                ...
                <div class="panel panel-transparent">
                    <div class="panel-body">
                        <table class="table table-striped" data-datatable-name="order_list"
                               data-controller="OrderWorkingListAjaxController"
