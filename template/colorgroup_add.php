                                    ...
                                    <div class="row clearfix">
                                        <div class="col-md-4">
                                            <div class="form-group form-group-default">
                                                <label>Nome Gruppo Colore</label>
                                                <input type="text" class="form-control" name="ProductColorGroup_name_<?php echo $lang->id; ?>" value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row clearfix">
                                        <div class="col-md-4">
                                            <div class="form-group form-group-default">
                                                <label>Slug ColorGroup</label>
                                                <input type="text" class="form-control" name="ProductColorGroup_slug_<?php echo $lang->id; ?>" value="">
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
...
<bs-toolbar class="toolbar-definition">
    <bs-toolbar-group data-group-label="Aggiungi">
        <bs-toolbar-button
            data-tag="a"
            data-icon="fa-floppy-o"
            data-permission="/admin/product/add"
            data-event="bs.color.add"
