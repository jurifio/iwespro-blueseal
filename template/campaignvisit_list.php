                        ...
                        <table class="table table-striped responsive" width="100%"
                            ...
                            <tr>
                                ...
                                <th data-slug="cost"
                                    data-searchable="true"
                                    data-orderable="true"
                                    class="center">Costo<br>Camp. Periodo</th>
                                <th data-slug="retailPrice"
                                    data-searchable="true"
                                    data-orderable="true"
                                    class="center">Prezzo Attivo</th>
                                <th data-slug="pondRetailPrice"
                                    data-searchable="true"
                                    data-orderable="true"
                                    class="center">Ponderazione<br>Retail Price</th>
                                <th data-slug="multiplierIs"
                                    data-searchable="true"
                                    data-orderable="true"
                                    class="center">Molt.</th>
                                <th data-slug="maxCos"
                                    data-searchable="true"
                                    data-orderable="true"
