                ...
                <div class="panel panel-transparent">
                    <div class="panel-body">
                        <table class="table table-striped responsive" width="100%"
                               data-datatable-name="bill_registrygroupproduct_list"
                               data-controller="BillRegistryGroupProductListAjaxController"
                            ...
                            <tr>
                                ...
                                <th data-slug="nameProduct"
                                    data-searchable="true"
                                    data-orderable="true"
                                    class="center">Nome <br>Gruppo Prodotto
                                </th>
...
<bs-toolbar class="toolbar-definition">
    <bs-toolbar-group data-group-label="Funzioni">
        <bs-toolbar-button
            data-remote="btn.addBillRegistryGroupProduct"
        ></bs-toolbar-button>
    </bs-toolbar-group>
</bs-toolbar>
</body>
