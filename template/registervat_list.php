            ...
            <div class="container-fluid container-fixed-lg bg-white">
                <div class="panel panel-transparent">
                    <div class="panel-body">
                        <table class="table table-striped" data-datatable-name="registervat_list"
                               data-controller="VatRegisterListAjaxController"
                            ...
                            <tr>
                                ...
                                <th data-slug="typeDocument"
                                    data-searchable="true"
                                    data-orderable="true"
                                    class="center">Tipo Documento
                                </th>
                                <th data-slug="invoiceNumber"
                                    data-searchable="true"
                                    data-orderable="true"
                                    class="center">Numero Documento
                                </th>
                                <th data-slug="invoiceDate"
                                    data-searchable="true"
                                    data-orderable="true"
                                    class="center">Data Documento
                                </th>
