 ...
 * @since 1.0
 */
class CEbayMarketplaceDisplayCatalogProductListController extends ARestrictedAccessRootController
{
    protected $fallBack = "blueseal";
    protected $pageSlug = "ebay_marketplacedisplaycatalog_product";
    ...
    public function get()
    {
        ...
        if(isset($_GET['pageid'])){
           ...
           join MarketplaceHasShop mphs on phphmhs.marketplaceHasshopId=mphs.id 
            ...
            where 1=1 and   p.qty>0 and m.id=3 and phphmhs.isPublished=1  ".$marketplaceHasShopIdFind.$productBrandIdFind.$productCategoryIdFind;
        ...
        $sql = "
            ...
            where p.qty >0 and m.id=3 and phphmhs.isPublished=1 and phphmhs.refMarketplaceId is not null  ".$marketplaceHasShopIdFind.$productBrandIdFind.$productCategoryIdFind."
