 ...
 */
class CFriendTransportDocumentWithFile extends AAjaxController
{
    public function get()
    {
    ...
    public function post() {
        ...
        try {
            ...
            \Monkey::app()->applicationError(
                'FriendOrderRecordInvoice', 'errore grave inserimento DDT con file', $e->getMessage()
            );
            return $e->getMessage();
        }
    }
