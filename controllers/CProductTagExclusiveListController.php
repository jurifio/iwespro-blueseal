...
/**
 * Class CProductTagExclusiveListController
 ...
 * @since ${VERSION}
 */
class CProductTagExclusiveListController extends ARestrictedAccessRootController
{
    protected $fallBack = "blueseal";
    protected $pageSlug = "product_tag_exclusive_list";

    public function get()
    {
        $view = new VBase(array());
        $view->setTemplatePath($this->app->rootPath().$this->app->cfg()->fetch('paths', 'blueseal') . '/template/product_tag_exclusive_list.php');
