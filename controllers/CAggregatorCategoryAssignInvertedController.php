...
/**
 * Class CAggregatorCategoryAssignInvertedController
 ...
 * @since 1.0
 */
class CAggregatorCategoryAssignInvertedController extends ARestrictedAccessRootController
{
    protected $fallBack = "blueseal";
    protected $pageSlug = "aggregator_category_assign_inverted";

    public function get()
    {
        $view = new VBase(array());
        $view->setTemplatePath($this->app->rootPath() . $this->app->cfg()->fetch('paths', 'blueseal') . '/template/aggregator_category_assign_inverted.php');
