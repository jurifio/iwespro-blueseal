...
/**
 * Class CNameTranslateLangAllListController
 ...
 * @since 1.0
 */
class CNameTranslateLangAllListController extends ARestrictedAccessRootController
{
    protected $fallBack = "blueseal";
    protected $pageSlug = "name_langall_list";
