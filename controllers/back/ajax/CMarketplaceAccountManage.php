...
"priceModifierRange5":"'.$collectData['priceModifierRange5'].'","valueexcept5":'.$collectData['valueexcept5'].',"maxCos2":'.$collectData['maxCos5'].',"range5Cpc":'.$range5Cpc.',"productSizeGroup5":'.$productSizeGroup5.',"productCategoryId5":'.$collectData['productCategoryId5'].'}';
