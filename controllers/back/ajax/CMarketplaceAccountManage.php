...
"budgetMonth":'.$collectData['budgetMonth'].' ,"defaultCpcM":'.$collectData['defaultCpcM'].',"defaultCpcF":'.$collectData['defaultCpcF'].', "defaultCpcFM":'.$collectData['defaultCpcFornitoreMobile'].',"emailDepublish":"'.$collectData['emailDepublish'].'","emailNotifyOffline":"'.$collectData['emailNotifyOffline'].'",
...
"priceModifierRange5":"'.$collectData['priceModifierRange5'].'","valueexcept5":'.$collectData['valueexcept5'].',"maxCos2":'.$collectData['maxCos5'].',"range5Cpc":'.$collectData['range5Cpc'].',"productSizeGroup5":'.$collectData['productSizeGroup5'].',"productCategoryId5":'.$collectData['productCategoryId5'].'}';
