 ...
 * @since 1.0
 */
class CPrestashopAlignCategory extends AAjaxController
{
...
SELECT
  ...
  concat(S3.productId,'-',S3.productVariantId,'-',S3.productSizeId)              AS productpublicksku,
  ...
  concat(p.id,'-',p.productVariantId)                                            AS short_desciption,
  NOW()                                                                          AS date_add,
  NOW()                                                                          AS date_upd,
...
$this->make_father_product_update($data);
    ...
    try {
        ...
        $combination->supplier_reference =$data['productpublicksku'];
