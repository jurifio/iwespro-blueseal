...
/**
 * Class COrderMixStatusLineListAjaxController
 ...
 * @since 1.0
 */
class COrderMixStatusLineListAjaxController extends AAjaxController
{
    public function get()
    {
        ...
        $sql = "SELECT
                ...
                WHERE  `o`.`status` LIKE 'ORD_MIX'  GROUP BY ol.id , ol.orderId";
