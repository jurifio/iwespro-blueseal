...
/**
 * Class CRbacPermissionTreeController
 ...
 * @since 1.0
 */
class CRbacPermissionTreeController extends AAjaxController
{
    public function get()
    {
        ...
        if (!$cache) {
            ...
            $permission = $this->app->rbacManager->perms()->treeToJson(1,'title');
    ...
    public function post()
    {
        ...
        $id = \Monkey::app()->rbacManager->addPermission($data['title'],$data['description'],$data['parent']);
