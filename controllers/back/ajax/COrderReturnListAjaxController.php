...
/**
 * Class COrderReturnListAjaxController
 ...
 * @since 1.0
 */
class COrderReturnListAjaxController extends AAjaxController
{
    public function get()
    {
        ...
        $sql = "SELECT
                ...
                WHERE `o`.`status` LIKE 'ORD_RETURNED'   GROUP BY ol.id, ol.orderId";
