...
/**
 * Class CTradeTrackerAggregatorProductListAjaxController
 ...
 * @since 1.0
 */
class CTradeTrackerAggregatorProductListAjaxController extends AAjaxController
{
    public function get()
    {
        ...
        $sql = "
            ...
            where p.qty>0  and   mahp.marketplaceId=10  and mahp.isDeleted=0  ".$sqlFilterAccount."
