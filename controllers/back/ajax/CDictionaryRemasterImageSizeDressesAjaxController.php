...
/**
 * Class CDictionaryRemasterImageSizeDressesAjaxController
...
class CDictionaryRemasterImageSizeDressesAjaxController extends AAjaxController
{
    ...
    public function POST()
    {
        ...
        $today = new \DateTime();
        $resultdate = '_dresses_'.$today->format('Y-m-d');
...
//definisco l'ambiente di sviluppo
        if (ENV == 'dev') {
            ...
            $path = 'shootImport/resizedresses';
            ...
            foreach ($contents as $item) {
                ...
                if ($result == true) {
                    ...
                    if (!file_exists($localDirectory)) {
                        if (!mkdir($localDirectory) && !is_dir($localDirectory)) {
