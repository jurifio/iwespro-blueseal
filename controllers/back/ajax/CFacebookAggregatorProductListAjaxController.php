...
/**
 * Class CFacebookAggregatorProductListAjaxController
 ...
 * @since 1.0
 */
class CFacebookAggregatorProductListAjaxController extends AAjaxController
{
    public function get()
    {
        $sql = "
            ...
            where p.qty>0  and   mahp.marketplaceId=14  and mahp.isDeleted=0
