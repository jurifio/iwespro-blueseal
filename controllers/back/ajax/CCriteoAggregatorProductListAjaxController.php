...
/**
 * Class CCriteoAggregatorProductListAjaxController
 ...
 * @since 1.0
 */
class CCriteoAggregatorProductListAjaxController extends AAjaxController
{
    public function get()
    {
        ...
        $sql = "
            ...
            where p.qty>0  and   mahp.marketplaceId=7  and mahp.isDeleted=0 ".$sqlFilterAccount."
