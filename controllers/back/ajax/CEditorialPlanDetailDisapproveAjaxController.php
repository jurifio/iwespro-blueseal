...
/**
 * Class CEditorialPlanDetailDisapproveAjaxController
 ...
 * @since 1.0
 */
class CEditorialPlanDetailDisapproveAjaxController extends AAjaxController
{
    ...
    public function post()
    {
        ...
        $subject='Revisione Post'. $editorialPlanDetail->id. ' '.$editorialPlanDetail->title;
        $message='il post è da Revisionare </br>Motivo della  Revisione:</br>'.$data['motive'];
        $to=['gianluca@iwes.it'];
