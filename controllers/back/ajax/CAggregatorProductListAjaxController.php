 ...
 * @since 1.0
 */
class CAggregatorProductListAjaxController extends AAjaxController
{
    public function get()
    {
        $sql = "
            ...
            LEFT JOIN MarketplaceAccountHasProduct mahp ON ahp.productId = mahp.productId AND ahp.productVariantId = mahp.productVariantId
