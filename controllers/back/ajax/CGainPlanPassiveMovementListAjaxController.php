...
class CGainPlanPassiveMovementListAjaxController extends AAjaxController
{
    public function get()
    {
       ...
       from GainPlanMassiveMovement gppm ORDER BY dateMovement DESC
        ...
        foreach ($datatable->getResponseSetData() as $key => $row) {
            ...
            $val = \Monkey::app()->repoFactory->create('GainPlanPassiveMovement')->findOneBy($row);
                ...
                $row['id'] = '<a href="/blueseal/gainplan/passivemovement-aggiungi?id='.$val->printId().'">'.$val->printId().'</a>';
