...
/**
 * Class CGetFattureinCloudInvoiceListAjaxController
...
class CGetFattureinCloudInvoiceListAjaxController extends AAjaxController
{
  ...
  "pagina": 1
            ...
            for ($i=0;$i<$iresult;$i++){
                ...
                if(is_null($findIfInvoiceExist)){
                    if($sectional=='W') {
                        ...
                        $noexist='fattura inserita';
                    } else {


                        $noexist = 'Fattura non del friend';
                    }



                }else{
                    $noexist=' fattura gia esistente';
                }
        ...
        \Monkey::app()->applicationLog('CGetFattureinCloudInvoiceListJob', 'Report', 'Get Fatture in cloud Friend', $res);
    }
}