 ...
 * @since 1.0
 */
class CNewsletterTemplateDelete extends AAjaxController
{
    ...
    public function delete(){
        ...
        /** @var CNewsletterTemplate $newsletter */
        $newsletter = $newsletterTemplate->findOneBy(['id'=>$id]);
        $newsletter->delete();
        $res = "Template Newsletter Cancellato";
        return $res;
