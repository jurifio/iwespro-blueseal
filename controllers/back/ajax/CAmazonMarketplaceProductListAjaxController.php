...
/**
 * Class CAmazonMarketplaceProductListAjaxController
 ...
 * @since 1.0
 */
class CAmazonMarketplaceProductListAjaxController extends AAjaxController
{
    public function get()
    {
        ...
        foreach ($datatable->getResponseSetData() as $key => $row) {
            ...
            $tableSaldi='';
           /* $mpas = $mpaRepo->findBy(['marketplaceId' => 4,'isActive' => 1]);
            if($mpas) {
                foreach ($mpas as $mpa) {
