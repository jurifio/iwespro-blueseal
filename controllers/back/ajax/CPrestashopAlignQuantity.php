            ...
            foreach ($res_product as $value_product) {
             ...
             WHERE id_product=" . $p);
                ...
                if ($value_product['titleSale'] == 1) {
                    ...
                    $stmtUpdateProductLang = $db_con->prepare("UPDATE psz6_product_lang SET `description_short`='" . $descriptionTextSaleLang2 . "', `description`='" . $descriptionTextSaleLang2 . "',`name`='" . $titleTextSaleLang2 . "', meta_title='" . $titleTextSaleLang2 . "' WHERE id_product=" . $p . " AND id_lang=2 AND id_shop=" . $value_product['shopPrestashopId'] . "  ");
                    $stmtUpdateProductLang->execute();
                    $stmtUpdateProductLang = $db_con->prepare("UPDATE psz6_product_lang SET `description_short`='" . $descriptionTextSaleLang1 . "', `description`='" . $descriptionTextSaleLang1 . "',`name`='" . $titleTextSaleLang1 . "', meta_title='" . $titleTextSaleLang1 . "' WHERE id_product=" . $p . " AND id_lang=1 AND id_shop=" . $value_product['shopPrestashopId'] . "  ");
                    $stmtUpdateProductLang->execute();
