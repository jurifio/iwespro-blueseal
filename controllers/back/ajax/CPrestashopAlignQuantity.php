            ...
            foreach ($res_product as $value_product) {
             ...
             WHERE id_product=" . $p);
                ...
                if ($value_product['titleSale'] == 1) {
                    ...
                    $descriptionTextSaleLang2 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " ". $category . " " . $productnameName . " " . $productitemnoName . " " . $productcolorSupplierName . " Scontato del " . number_format($value_product['percentSale'],0,',','.') . " %  da € " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a € " . number_format($value_product['salePrice'], 2, ',', '.'));
                    $descriptionTextSaleLang1 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " ". $category . " " . $productnameName . " " . $productitemnoName . " " . $productcolorSupplierName .  "Special Discount " . number_format($value_product['percentSale'],0,',','.') . " % OFF from  € " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " to € " . number_format($value_product['salePrice'], 2, ',', '.'));
                    $descriptionTextSaleLang3 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " ". $category . " " . $productnameName . " " . $productitemnoName . " " . $productcolorSupplierName . " Special Discount  " . number_format($value_product['percentSale'],0,',','.') . " % OFF from  € " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " to € " . number_format($value_product['salePrice'], 2, ',', '.'));
...
//
                    ...
                    $descriptionTextSaleLang2 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " " . $category . " " . $productnameName . " " . $productitemnoName . " " . $productcolorSupplierName);
                    $descriptionTextSaleLang1 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " " . $category . " " . $productnameName . " " . $productitemnoName . " " . $productcolorSupplierName);
                    $descriptionTextSaleLang3 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " " . $category . " " . $productnameName . " " . $productitemnoName . " " . $productcolorSupplierName);
