            ...
            foreach ($res_product as $value_product) {
             ...
             WHERE id_product=" . $p);
                ...
                if ($value_product['titleSale'] == 1) {
                    ...
                    $descriptionshortTextSaleLang2 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " Sconto del " . number_format($value_product['percentSale'],0,',','.') ." %  da Euro " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a Euro " . number_format($value_product['salePrice'], 2, ',', '.'));
                    $descriptionshortTextSaleLang1 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " Sconto del  " . number_format($value_product['percentSale'],0,',','.') . " % da Euro " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a Euro " . number_format($value_product['salePrice'], 2, ',', '.'));
                    $descriptionshortTextSaleLang3 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " Sconto del  " . number_format($value_product['percentSale'],0,',','.') . " % da Euro " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a Euro " . number_format($value_product['salePrice'], 2, ',', '.'));
