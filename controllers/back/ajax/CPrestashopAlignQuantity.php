 ...
 * @since 1.0
 */
class CPrestashopAlignQuantity extends AAjaxController
{
            ...
            foreach ($res_product as $value_product) {
             ...
             WHERE id_product=" . $p);
                ...
                if ($value_product['titleSale'] == 1) {
                    ...
                    $titleTextSaleLang2 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) .  " Sconto del " . number_format($value_product['percentSale'],0,',','.') . " %  da € " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a € " . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );
                    $titleTextSaleLang1 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName)  . " SALE  " . number_format($value_product['percentSale'],0,',','.') . " % OFF from € " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " to € " . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );
                    $titleTextSaleLang3 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName)  . " SALE   " . number_format($value_product['percentSale'],0,',','.') . " %  OFF from  € " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " to € " . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );
                    $descriptionTextSaleLang2 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " " . $productnameName . " " . $productitemnoName . " " . $productcolorSupplierName . " Scontato del " . number_format($value_product['percentSale'],0,',','.') . " %  da € " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a € " . number_format($value_product['salePrice'], 2, ',', '.'));
                    $descriptionTextSaleLang1 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " " . $productnameName . " " . $productitemnoName . " " . $productcolorSupplierName .  "Special Discount " . number_format($value_product['percentSale'],0,',','.') . " % OFF from  € " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " to € " . number_format($value_product['salePrice'], 2, ',', '.'));
                    $descriptionTextSaleLang3 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " " . $productnameName . " " . $productitemnoName . " " . $productcolorSupplierName . " Special Discount  " . number_format($value_product['percentSale'],0,',','.') . " % OFF from  € " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " to € " . number_format($value_product['salePrice'], 2, ',', '.'));
                    $descriptionshortTextSaleLang2 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " Sconto del " . number_format($value_product['percentSale'],0,',','.') . " %  da € " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a € " . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );
                    $descriptionshortTextSaleLang1 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " SALE  " . number_format($value_product['percentSale'],0,',','.') . " % OFF from € " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " to € " . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );
                    $descriptionshortTextSaleLang3 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " SALE " . number_format($value_product['percentSale'],0,',','.') . " % OFF from € " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " to € " . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );

                    $stmtUpdateProductLang = $db_con->prepare("UPDATE psz6_product_lang SET  description_short='".$descriptionshortTextSaleLang2."',`description`='" . $descriptionTextSaleLang2 . "',`name`='" . $titleTextSaleLang2 . "', meta_title='" . $titleTextSaleLang2 . "' WHERE id_product=" . $p . " AND id_lang=2 AND id_shop=" . $value_product['shopPrestashopId'] . "  ");
                    $stmtUpdateProductLang->execute();
                    $stmtUpdateProductLang = $db_con->prepare("UPDATE psz6_product_lang SET description_short='".$descriptionshortTextSaleLang1."', `description`='" . $descriptionTextSaleLang1 . "',`name`='" . $titleTextSaleLang1 . "', meta_title='" . $titleTextSaleLang1 . "' WHERE id_product=" . $p . " AND id_lang=1 AND id_shop=" . $value_product['shopPrestashopId'] . "  ");
                    $stmtUpdateProductLang->execute();
...
//
                    ...
                    $productitemnoName = $dirtyProduct->itemno;
                    $productcolorSupplierName = $dirtyProduct->var;
                    $titleTextSaleLang2 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) .  " Sconto del " . number_format($value_product['percentSale'],0,',','.') . "% da &euro;" . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a &euro;" . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );
                    $titleTextSaleLang1 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName)  . " SALE " . number_format($value_product['percentSale'],0,',','.') . "% OFF from &euro;" . number_format($value_product['priceMarketplace'], 2, ',', '.') . " to &euro;" . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );
                    $titleTextSaleLang3 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName)  . " SALE " . number_format($value_product['percentSale'],0,',','.') . "%  OFF from  &euro;" . number_format($value_product['priceMarketplace'], 2, ',', '.') . " to &euro;" . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );
                    ...
                    $descriptionTextSaleLang1 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " " . $productnameName . " " . $productitemnoName . " " . $productcolorSupplierName .  "Special Discount " . number_format($value_product['percentSale'],0,',','.') . "% OFF from  &euro;" . number_format($value_product['priceMarketplace'], 2, ',', '.') . " to &euro;" . number_format($value_product['salePrice'], 2, ',', '.'));
                    $descriptionTextSaleLang3 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " " . $productnameName . " " . $productitemnoName . " " . $productcolorSupplierName . " Special Discount  " . number_format($value_product['percentSale'],0,',','.') . "% OFF from  &euro;" . number_format($value_product['priceMarketplace'], 2, ',', '.') . " to &euro;" . number_format($value_product['salePrice'], 2, ',', '.'));
                    $descriptionshortTextSaleLang2 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " Sconto del " . number_format($value_product['percentSale'],0,',','.') . "% da &euro;" . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a &euro;" . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );
                    $descriptionshortTextSaleLang1 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " SALE  " . number_format($value_product['percentSale'],0,',','.') . "% OFF from &euro;" . number_format($value_product['priceMarketplace'], 2, ',', '.') . " to &euro;" . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );
                    $descriptionshortTextSaleLang3 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " SALE " . number_format($value_product['percentSale'],0,',','.') . "% OFF from &euro;" . number_format($value_product['priceMarketplace'], 2, ',', '.') . " to &euro;" . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );
