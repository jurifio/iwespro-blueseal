            ...
            foreach ($res_product as $value_product) {
             ...
             WHERE id_product=" . $p);
                ...
                if ($value_product['titleSale'] == 1) {
                    ...
                    $titleTextSaleLang1 = str_replace("'", "\'", $productbrandName) . " " . $productnameName . " " . $productitemnoName . " " . $productcolorSupplierName . " Sale " . number_format($value_product['percentSale'],0,',','.') . " % da Euro " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a Euro " . number_format($value_product['salePrice'], 2, ',', '.');
                    $titleTextSaleLang3 = str_replace("'", "\'", $productbrandName) . " " . $productnameName . " " . $productitemnoName . " " . $productcolorSupplierName . " Sale " . number_format($value_product['percentSale'],0,',','.') . " % da From Euro " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a Euro " . number_format($value_product['salePrice'], 2, ',', '.');
                    ...
                    $descriptionshortTextSaleLang1 =  " Sconto del  " . $value_product['percentSale'] . " % da Euro " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " To Euro " . number_format($value_product['salePrice'], 2, ',', '.');
                    $descriptionshortTextSaleLang3 =  " Sconto del  " . $value_product['percentSale'] . " % da Euro " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " To Euro " . number_format($value_product['salePrice'], 2, ',', '.');
