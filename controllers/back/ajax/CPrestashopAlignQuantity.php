            ...
            foreach ($res_product as $value_product) {
             ...
             WHERE id_product=" . $p);
                ...
                if ($value_product['titleSale'] == 1) {
                    ...
                    $titleTextSaleLang1 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName)  . " SALE  " . number_format($value_product['percentSale'],0,',','.') . "% OFF from EUR " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " to EUR " . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );
                    $titleTextSaleLang3 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName)  . " SALE   " . number_format($value_product['percentSale'],0,',','.') . "%  OFF from  EUR " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " to EUR " . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );
                    $descriptionTextSaleLang2 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " ". $category . " " . $productnameName . " " . $productitemnoName . " " . $productcolorSupplierName . " Scontato del " . number_format($value_product['percentSale'],0,',','.') . "%  da EUR " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a EUR " . number_format($value_product['salePrice'], 2, ',', '.'));
                    $descriptionTextSaleLang1 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " ". $category . " " . $productnameName . " " . $productitemnoName . " " . $productcolorSupplierName .  "Special Discount " . number_format($value_product['percentSale'],0,',','.') . "% OFF from  EUR " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " to EUR " . number_format($value_product['salePrice'], 2, ',', '.'));
                    $descriptionTextSaleLang3 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " ". $category . " " . $productnameName . " " . $productitemnoName . " " . $productcolorSupplierName . " Special Discount  " . number_format($value_product['percentSale'],0,',','.') . "% OFF from  EUR " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " to EUR " . number_format($value_product['salePrice'], 2, ',', '.'));
                    $descriptionshortTextSaleLang2 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " Sconto del " . number_format($value_product['percentSale'],0,',','.') . "%  da EUR " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " a EUR " . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );
                    $descriptionshortTextSaleLang1 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " SALE  " . number_format($value_product['percentSale'],0,',','.') . "% OFF from EUR " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " to EUR " . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );
                    $descriptionshortTextSaleLang3 = iconv('UTF-8', 'ISO-8859-1//TRANSLIT//IGNORE',str_replace("'", "\'", $productbrandName) . " SALE " . number_format($value_product['percentSale'],0,',','.') . "% OFF from EUR " . number_format($value_product['priceMarketplace'], 2, ',', '.') . " to EUR " . number_format($value_product['salePrice'], 2, ',', '.')." ". $productitemnoName . " " . $productcolorSupplierName );
