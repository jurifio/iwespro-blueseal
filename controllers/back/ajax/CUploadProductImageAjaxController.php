...
/**
 * Class CUploadProductImageAjaxController
 ...
 * @since 1.0
 */
class CUploadProductImageAjaxController extends AAjaxController
{
    public function post()
    {
        ...
        $tempFolder = $this->app->rootPath() . $this->app->cfg()->fetch('paths','tempFolder') . '-productIwes/';
        $origintempFolder = $this->app->rootPath() . $this->app->cfg()->fetch('paths','tempFolder') . '-productIwes';
        ...
        try {
            ...
            $res = $image->putImage($config['bucket'],$newdestination,'iwes-productIwes',$newname);
