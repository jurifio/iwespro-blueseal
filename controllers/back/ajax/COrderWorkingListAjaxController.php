 ...
 * @since 1.0
 */
class COrderWorkingListAjaxController extends AAjaxController
{
    public function get()
    {
        ...
        $sql = "SELECT
                ...
                WHERE `o`.`status` LIKE 'ORD_PENDING' OR `o`.`status` LIKE 'ORD_WORK' OR `o`.`status` LIKE 'ORD_WAIT'  GROUP BY ol.id, ol.orderId";
