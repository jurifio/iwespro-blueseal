...
/**
 * Class CStylightAggregatorProductListAjaxController
 ...
 * @since 1.0
 */
class CStylightAggregatorProductListAjaxController extends AAjaxController
{
    public function get()
    {
        ...
        $sql = "
            ...
            where p.qty>0  and   mahp.marketplaceId=9  and mahp.isDeleted=0 ".$sqlFilterAccount."
