 ...
 * @since ${VERSION}
 */
class CProductImporterCartechiniController extends ARestrictedAccessRootController
{
    protected $fallBack = "blueseal";
    protected $pageSlug = "product_incomplete_cartechini_import";

    public function get()
    {
        $view = new VBase(array());
        $view->setTemplatePath($this->app->rootPath().$this->app->cfg()->fetch('paths','blueseal').'/template/product_incomplete_cartechini_import.php');
