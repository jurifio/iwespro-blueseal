...
/**
 * Class CDictionaryColorEditController
 ...
 * @since 1.0
 */
class CDictionaryColorEditController extends ARestrictedAccessRootController
{
    protected $fallBack = "blueseal";
    protected $pageSlug = "dictionary_color_edit";
