 ...
 * @since ${VERSION}
 */
class CProductListController extends ARestrictedAccessRootController
{
    ...
    public function get()
    {
        ...
        $view->setTemplatePath($this->app->rootPath().$this->app->cfg()->fetch('paths', 'blueseal') . '/template/product_list.php');
