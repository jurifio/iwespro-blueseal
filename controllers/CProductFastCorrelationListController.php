...
/**
 * Class CProductFastCorrelationListController
 ...
 * @since 1.0
 */
class CProductFastCorrelationListController extends ARestrictedAccessRootController
{
    protected $fallBack = "blueseal";
    protected $pageSlug = "product_fastcorrelation_list";

    public function get()
    {
        $view = new VBase(array());
        $view->setTemplatePath($this->app->rootPath().$this->app->cfg()->fetch('paths', 'blueseal') . '/template/product_fastcorrelation_list.php');
